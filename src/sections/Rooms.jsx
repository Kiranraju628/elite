        ...
        <section id="rooms" className="section">
            <div className="container">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <span className="text-pink-600 font-semibold tracking-wider text-sm uppercase">Pricing & Plans</span>
                    ...
                    {rooms.options.map((room) => (
                        ...
                        >
                            ...
                            <div className="p-8 flex-1 flex flex-col">
                                ...
                                <p className="text-3xl font-bold text-pink-600 mb-6">{room.price}</p>
                                ...
                                <a href="#contact" className="w-full py-3 rounded-lg border-2 border-pink-600 text-pink-600 font-semibold text-center hover:bg-pink-600 hover:text-white transition-colors">
                                    Enquire Now
                                </a>
                            </div>
                        </motion.div>
